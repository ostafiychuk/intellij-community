...
public class GitLogParser {
  ...
  List<GitLogRecord> parse(@NotNull String output) {
    ...
    Matcher matcher = ONE_RECORD.matcher(output); // split by START, because END is the end of information, but not the end of the record: file status and path follow.
